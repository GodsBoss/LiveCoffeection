...
describe "A transformation method", ()->
	...
	it "returns a collection with values generated by the transformer.", ()->

		LiveCollection.addTransformer "empty", ()->
			[]

		collection = new MutableCollection [1, 2, 3]
		expect(collection.empty().values()).toEqual []
	...
	describe "Collection created via a transform method.", ()->
		...
		it "gives access to the values generated by the transformer.", ()->
			...
			collection = new MutableCollection []
			transformedValues = collection.transform().values()

			expect(transformedValues).toEqual data

		it "returns a clone of the values so changes are ignored.", ()->
			...
			collection = new MutableCollection []
			transformedCollection = collection.transform()
			transformedCollection.values()[1] = 3

			expect(transformedCollection.values()[1]).toEqual originalData[1]
